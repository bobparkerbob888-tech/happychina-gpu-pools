...
INSERT INTO coins (
  ...
  (7,  'Litecoin',  'LTC',   '', 'scrypt', 'https://blockchair.com/litecoin/block/', 1, 0.001, 0.001, NULL, 150, 1, 0, 6.25, 1, 100, 1, 1, 1, 0, UNIX_TIMESTAMP(), '.litecoin',  'litecoind',  'umbrel', 'umbrel', 'daemons',  9332,  'POW', '', 1, 1, 0, 0, 1, 0, 0, 0, 1, 1, 'https://litecoin.org', 'https://github.com/litecoin-project/litecoin', 'https://blockchair.com/litecoin/block/'),
  ...
  (9,  'Bells',     'BELLS', '', 'scrypt', '',                                        3, 0.001, 0.001, NULL,  60, 1, 0, 0,     1, 240, 1, 1, 1, 1, UNIX_TIMESTAMP(), '.bells',     'bellsd',     'umbrel', 'umbrel', 'daemons', 19918,  'POW', '', 1, 1, 0, 0, 1, 0, 1, 0, 1, 1, 'https://bellscoin.technology', 'https://github.com/Nintondo/bellscoinV3', ''),
  ...
  (11, 'Pepecoin',  'PEPE',  '', 'scrypt', '',                                        5, 0.001, 0.001, NULL,  60, 1, 0, 0,     1, 240, 1, 1, 1, 1, UNIX_TIMESTAMP(), '.pepecoin',  'pepecoind',  'umbrel', 'umbrel', 'daemons', 29373,  'POW', '', 1, 1, 0, 0, 0, 0, 1, 0, 1, 1, 'https://pepecoin.org', 'https://github.com/pepecoin-project/pepecoin', ''),
...
UPDATE coins SET auto_exchange = 0, enable_rpcdebug = 0, sellthreshold = 10000
