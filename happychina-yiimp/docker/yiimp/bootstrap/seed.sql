...
INSERT INTO coins (
  ...
  (11, 'Pepecoin',  'PEPE',  '', 'scrypt', '',                                        5, 0.001, 0.001, NULL,  60, 1, 0, 0,     1, 240, 1, 1, 1, 1, UNIX_TIMESTAMP(), '.pepecoin',  'pepecoind',  'umbrel', 'umbrel', 'daemons', 33873,  'POW', '', 1, 1, 0, 0, 0, 0, 1, 0, 1, 1, 'https://pepecoin.org', 'https://github.com/pepecoinppc/pepecoin', ''),
